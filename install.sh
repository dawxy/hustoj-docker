...
apt-get install -y make flex g++ clang libmysqlclient-dev libmysql++-dev php-fpm nginx php-mysql php-gd php-zip fp-compiler openjdk-8-jdk mono-devel php-mbstring php-xml
USER=root
PASSWORD=xy950328
mkdir etc data log
